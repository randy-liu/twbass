...
| 檔案 | 受眾 | 定位 |
|------|------|------|
| `台灣大嘴黑鱸白皮書featFable5-junior.md` | 路亞初階釣手 | 實戰決策、白話 how-to |
| `台灣大嘴黑鱸白皮書featFable5-senior.md` | 路亞中階／資深釣手 | 精確閾值與機制「為什麼」 |
| `台灣大嘴黑鱸白皮書featFable5-expert.md` | 專業／競技釣手 | 逆向診斷、信心校準、決策科學 |
...
- 三份共通的數值（如溶氧 mg/L）皆附「不用儀器的現場判讀法」，避免讀者拿到無法落地的數字。
