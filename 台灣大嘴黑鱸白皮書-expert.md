...
**風生流 × 水體 × 季節。** 風把表層食物推到**下風岸**（看泡沫、浮渣聚成的線），魚跟去結構後方緩流死角——這條一律成立。差別在風攪得到多深：淺塘從表到底都動、直接打下風岸；深水庫**夏季分層**風只動躍溫層以上、食物與魚鎖在上層下風區（躍溫層以下找不到），**秋冬混合**整片水一起動、一樣打下風岸但要整層搜。強度看水面：細紋小浪＝甜區（5–12 cm/s），浪大拍岸、控不住餌＝過頭（>20 cm/s）、魚退避風側的緩流死角。
