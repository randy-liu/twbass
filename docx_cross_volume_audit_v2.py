...
FILES = OrderedDict([
    ...
    ("4A", BASE / "4A：繁衍地球化學與水文干擾.md"),
    ("4B", BASE / "4B：棲位競爭、容載量與護巢防禦.md"),
...
def main():
    ...
    param_specs = [
        ...
        },
        {
            ...
            "expected_docs": ["2B"],
            "scan_docs": ["2B", "4B"],
            "anchor_groups": [[r"\bSNs\b", r"表淺神經丘", r"Superficial [Nn]euromasts", r"游離側線"]],
            "checks": [("1-20 Hz", r"1\s*[-–~至]\s*20\s*Hz")],
        },
        {
        ...
        },
        {
            ...
            "scan_docs": ["1B1", "SUP-B"],
            "anchor_groups": [[r"Fe2\+", r"Fe2\+", r"亞鐵", r"Fe²\+"], [r"30\s*[-–~至]\s*50\s*cm"]],
            "checks": [("30-50 cm", r"30\s*[-–~至]\s*50\s*cm")],
        },
        {
            "name": "H2S安全距離 靜水",
            "expected": "55-65 cm",
        ...
        },
        {
            ...
            "expected_docs": ["1B1"],
            "scan_docs": ["1B1"],
            "anchor_groups": [[r"H2S", r"硫化氫"], [r"Zone[- ]?C", r"南部"], [r"60\s*[-–~至]\s*100\s*cm"]],
            "checks": [("60-100 cm", r"60\s*[-–~至]\s*100\s*cm")],
        },
        {
            "name": "H2S安全距離 擾動/水車",
            "expected": "120-160 cm",
