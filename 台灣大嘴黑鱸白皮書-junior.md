...
**線索三：風往哪吹，就往下風岸找。** 風把食物推去下風岸，魚跟去埋伏，所以**迎風岸（風吹過去那一側）通常是黃金釣點**。魚會躲在水流稍弱的結構物（石頭、倒木、橋墩）後方逆流等。但風太大、水流太急時，魚會退進結構後方的靜水區定點等——這時把餌慢慢送進那個靜水角落。
...
**連投節奏別太密：** 同一個點連續拋，魚會越來越警覺。北部冬天管理池至少隔 10～20 分鐘換點再回頭，南部夏天至少隔 3～5 分鐘。**中魚或跑魚後更要換點**——尤其南部水，化學警報素持續特別久（可達半天以上、影響半徑 4～7 公尺），那個點可能整天報廢，直接換 8 公尺以上。
...
蝦蟹剛脫殼那段（水溫超過 26°C 會頻繁脫殼），沒有硬殼、超好吃，魚會專一搜尋軟殼蝦蟹，價值瞬間翻 5～10 倍。**盛夏在結構區（倒木、石堆）用「帶鹽、超軟」的螯蝦／蝦型軟蟲貼底定點微抖**，正中這個窗口。記住：軟餌的「軟」和「帶鹽味」在這裡是關鍵，因為魚會用嘴試咬，太硬牠就吐了。
...
> **破除迷思：「颳風下雨好幾天，魚是不是缺氧死光？」不會。**
> - **缺氧是「翻起來那一下」的事，不是持續好幾天。** 風一直吹其實是在幫水加氧（攪動把空氣的氧打進水），吹越久氧越夠。
> - **冬天冷鋒**：魚是**冷到變懶、沉底**（不是缺氧）——打法要慢、要深、挑最暖的午後。
> - **夏天梅雨／颱風後西南氣流**：水還是溫的，降一點溫對魚反而舒服，氧也夠；真正難的是**水變濁、看不到餌**（改用會震動的軟餌、慢、貼近）。而且**颳風下雨「之前」那段（氣壓降）常常超好咬**，搶那個時機。
> - **只有一種要收竿**：南部那種爛泥厚的池被一次翻起來、整池有毒（很臭、一直冒泡），魚會逃或停口——換水域或等約一週恢復。
