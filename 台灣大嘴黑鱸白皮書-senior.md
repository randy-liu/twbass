...
魚從發現你的餌到真的咬下，是一條有五個階段的流水線；每一階段都可能把餌打槍。要注意的是，這條線裡有**兩個不同的判斷**——一個在遠處粗略快篩、一個在嘴邊精細審查，別把它們混為一談。
...
4. **評估（2–5 s）——近距離的精細審查，老魚最常打槍的一步。** 魚游到離餌只剩 15–30 cm 處尾隨，這時才調用端腦（大腦）的記憶逐項比對細節。你說的「靠近之後才判斷」就是這一步——真正的細看在這裡，不在第 2 步。
