...
也因此**能見度要「剛好夠被看到」、不是越鮮越好**：濁水偵測是瓶頸、被迫拉高對比；清水偵測不缺，反而要收斂（理由見下）。各水色怎麼選：

- **濁褐／丹寧水（能見度 <35 cm，CDOM 染茶褐）**：分兩路看——
  - **打剪影**（餌走魚上方、靠天光背景看輪廓）：要的是「比背景暗」，**純黑最強**、暗深藍次之，顏色本身不重要。
  - **要魚看到餌色**（中下層靠反射）：CDOM 專吃藍光（450 nm 在 22 cm 內衰減 90%），**紅／橙／暖色反而穿最深**（650 nm 到 68 cm 才衰減 90%）、才看得到。注意：「紅最先消失」只在清水成立，**茶褐水剛好相反、紅是最後消失的**。
- **綠藻水（藍綠菌爆發、均一綠）**：葉綠素連紅帶藍一起吃、只透綠黃，**純紅在綠水會變死灰、嚴禁**；用黃綠／Chartreuse 對比最強、穿最深。
- **清水至透光水（能見度 50–100 cm，深水水庫冷季最典型）**：偵測不是問題、魚看得久又清，所以①**收斂成半透明、自然寫實色**；②**別過度鮮豔**——高壓老魚會把激進顯眼的呈現跟「被釣痛」連在一起（lure-shyness），低調自然才不踩牠學到的警報（呼應 §九 老魚 finesse）。可用的清水視覺錨：麗紋石龍子亮藍尾（450–475 nm；清水中藍光衰減極低，是個**高亮度、高對比的顯眼點**——它靠的是亮度與對比、**不是黑鱸的藍色覺**，且**只在清水有效**，到褐水藍光被吃光就變暗失效）、米蝦半透明幾丁質反光（帶細亮片）、抱卵母蝦亮綠/黃卵塊。
