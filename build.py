...
GLOSSARY = [
    ...
    ("fanshui",             "翻水",             "",             "水體翻轉（Turnover）。表底層水密度差消失後，含 H₂S、Fe²⁺ 的缺氧底部毒水被翻攪至全水層。【觸發機制】有三種：①溫度驅動：冷鋒帶來 2–4°C 降溫 + 持續 ≥48 小時；②風力驅動：風速 >5 m/s 持續，Zone-B（桃竹苗）常態季風 6–10 m/s 極易觸發；③颱風/強降雨：25–40 m/s 陣風或暴雨可在數小時內強制全層混合（Ekman 混合深度 >15 m）。管理池水車停機遇冷鋒同樣觸發，但持續時間較短（<12 hr）。【水質衝擊】DO 崩至 <2 mg/L；Eh 跌破 −150 mV → H₂S 大量釋放；Fe²⁺ 於 Eh < 0 mV 即開始釋放。【魚的應對】完全停食，逃往有清水注入的淺灣氧氣庇護區，被迫懸浮離底 ≥40–160 cm（H₂S 擴散高度）。【恢復】Eh 回到 >+200 mV 需 10–15 天，魚群才會返回正常冬季棲位。【地區頻率】Zone-A（台北/宜蘭）：1–2 次/年，首次約 12 月；Zone-B（桃竹苗）：2–4 次/年，首次約 11 月（早一個月）；Zone-C（南部）：幾乎不發生。"),
