...
GLOSSARY = [
    ...
    ("fanshui",             "翻水",             "",             "水體翻轉（Turnover）。冬季冷鋒來襲、表層水溫降至接近 4°C 時，表底層密度差消失，含 H₂S、Fe²⁺ 的缺氧底部毒水被翻攪至全層，持續 24–48 小時。期間魚被迫懸浮中層（1.0–1.5 m），貼底操作無效。北部水庫與深埤塘每年 1–2 次（首次約 12 月）；Zone-B（桃竹苗）每年 2–4 次（首次約 11 月）。"),
