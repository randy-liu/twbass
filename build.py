...
GLOSSARY = [
    ...
    ("fanshui",             "翻水",             "",             "水體翻轉（Turnover）。表底層水密度差消失後，含 H₂S、Fe²⁺ 的缺氧底部毒水被翻攪至全水層。<br><br><strong>觸發機制（三種）</strong><ul class=\"gl-list-inner\"><li>①溫度驅動：冷鋒帶來 2–4°C 降溫 + 持續 ≥48 小時</li><li>②風力驅動：風速 &gt;5 m/s 持續；Zone-B（桃竹苗）常態季風 6–10 m/s 極易觸發</li><li>③颱風／強降雨：25–40 m/s 陣風或暴雨可在數小時內強制全層混合（Ekman 混合深度 &gt;15 m）；管理池水車停機遇冷鋒同觸發（&lt;12 hr）</li></ul><strong>水質衝擊</strong><ul class=\"gl-list-inner\"><li>DO 崩至 &lt;2 mg/L</li><li>Eh 跌破 −150 mV → H₂S 大量釋放（擴散高度 86–160 cm）</li><li>Fe²⁺ 於 Eh &lt; 0 mV 即開始釋放（影響離底 ≥40 cm）</li></ul><strong>魚的應對</strong>：完全停食，逃往有清水注入的淺灣氧氣庇護區，懸浮離底 ≥40–160 cm。<br><br><strong>恢復時程</strong>：Eh 回到 &gt;+200 mV 需 10–15 天，魚群才回正常棲位。<br><br><strong>地區頻率</strong><ul class=\"gl-list-inner\"><li>Zone-A（台北／宜蘭）：1–2 次／年，首次約 12 月</li><li>Zone-B（桃竹苗）：2–4 次／年，首次約 11 月（早一個月）</li><li>Zone-C（南部）：幾乎不發生</li></ul>"),
