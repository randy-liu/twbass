...
> - **分層底死區（推定，軟）**：南部＋深＋靜＋夏＋爛底 → 合理假設底層缺氧／有毒，但無原位讀數，只定方向不定值。
...
- 三區水溫跨越 22°C 時序（Zone-B 比 Zone-A 早 12–18 天）、雨遮效應 47%、冷氣團降幅與回溫天數。
- 北部酸性絮凝澄清 1–2 天 vs 南部 5–8 天（膠體化學＋Stokes 計算，硬）。
- 底泥體積熱容與保溫滯後（Zone-B 18–24 hr、南部 6–12 hr）。
...
**暴雨後的回場時機（物理 Lag）**：
- Zone-B 野塘 1–2 天、Zone-A 1.5–2.5 天就清——**北部暴雨後第 2–3 天是黃金期**：水剛清、魚處 naive 重置狀態、可切回視覺暖色餌破防。
- 南部野塘 5–8 天、南部水庫 10–15 天才清——**南部暴雨後前 5 天靠側線（大尾低頻、貼近、慢），第 6–8 天澄清才切回視覺黃綠系**。早回去只能側線戰。

**暴雨後底層復氧（地球化學 Lag）**：Zone-A 4–6 天、Zone-B 2–3 天、Zone-C 7–12 天才回到底泥有氧。**這決定『底層能不能打』比『水清不清』更關鍵**——南部水看起來清了但底層 Eh 還沒回，貼底仍是死區。
...
**寒流後的回溫（物理 Lag）**：Zone-A 5–7 天（持續陰雨）、Zone-B 3–4 天（迅速轉晴）、Zone-C 1.5–2.5 天（陡峭 V 反彈）。**南部寒流後反彈最快，第 2–3 天就能回；北部迎風面要等近一週。** 但注意第一天的反向操作：北部寒流剛來 0–24 hr，底泥保溫讓底層比表層高 2–3°C，是貼底黃金窗口，過了這天底層才真正變冷。
...
**Up-Strike 的多重閘門。** 仰攻同時受光場（晨昏漫射才開）、水溫（<12°C 抑制、<10 全停）、溶氧（<2.0 進入 ASR 即拒絕）、水色幾何（發動深度 Zone-A<30、Zone-C<50 cm）四重控制。**任一閘門關閉，表層系就失效**——所以低溫清晨溶氧又低時，再漂亮的 Topwater 操作也不會有仰攻，該果斷改中下層 Forward-Strike。
...
## 劇本五：北部野塘/管理池・秋末初冬・冷休克翻水
**環境**：寒流 48h 降溫 >8°C＋風≥6.5–8.5 觸發翻水，24–48 hr DO 降 1.5–2.5。**棲位**：棄底、表層 0–30 cm，貼避風岸殘荷倒木 10 cm 內。**黃金窗口**：寒流剛來 0–24 hr，底泥保溫讓底層高 2–3°C，貼底 10–20 cm 無鉛軟蟲微抖（<2 cm/s、15–30 Hz）。**速度**：極慢 <5 cm/s，Dead Stop 滿 2.5–3.5 s（冬季決策窗口 2.5 s，短於 2.0 直接拒）。**連投**：≥15–20 min（低溫皮質醇半衰期長）。
...
- **濁水（Zone-A <35 cm）**：CFF 低、細節無效，全靠剪影——純黑/深紅高對比。
- **清水（Zone-C 50–100 cm）**：細節核對嚴格——半透明寫實。可利用特定光學錨：麗紋石龍子亮藍尾（450–475 nm 藍光清水穿透強）、米蝦半透明幾丁質反光（細亮片）、抱卵母蝦亮綠/黃卵塊。
